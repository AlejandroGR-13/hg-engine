...
// SHINY_ODDS are the odds that a pokémon will be shiny.  actual odds are SHINY_ODDS over 65,536, vanilla HGSS is
// 8 / 65536 (1 / 8192) - set here to 33 / 65536, which is 1 / 1986 (as close as an integer numerator gets to 1 / 2000)
